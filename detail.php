<?php
    ...
    if (isset($_GET['tripID'])) {
        $tripID = $_GET['tripID'];
        // คุณสามารถใช้ $tripID ที่ได้รับมาแสดงหรือใช้ในการดึงข้อมูลอื่น ๆ ที่เกี่ยวข้องกับ tripID ได้ตามต้องการ
        // echo "รับค่า tripID แล้ว: " . $tripID;
    } else {
        // กรณีไม่มีค่า tripID ใน URL
        echo "ไม่ได้รับค่า tripID";
    }
?>
