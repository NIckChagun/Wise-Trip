...
<body>
    ...
    <div class="album py-5 bg-body-tertiary" id="lifestyle">
        ...
        <div id="head-style"><h1>เลือกกิจกรรมที่คุณสนใจ</h1></div>
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-5" id="row">
                ...
                <div class="col">
                    <div class="card shadow-sm" id="card">
                        ...
                        <div class="option_inner facebook">
                            <img src="image/dive.jpg"width="100%" height="400">
                            <div class="name"><h1>ดำน้ำ</h1></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card shadow-sm" id="card">
                        ...
                        <input type="checkbox" class="checkbox">
                        <div class="option_inner facebook">
                            <img src="image/hiking.jpg"width="100%" height="400">
                            <div class="name"><h1>เดินป่า</h1></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    ...
                    <label class="option_item">
                        <input type="checkbox" class="checkbox">
                        <div class="option_inner facebook">
                        <img src="image/shopping.jpg"width="100%" height="400">
                ...
                <div class="col">
                    ...
                    <input type="checkbox" class="checkbox">
                        <div class="option_inner facebook">
                        <img src="image/party.jpg"width="100%" height="400">
                            <div class="name"><h1>ปาร์ตี้</h1></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    ...
                    <input type="checkbox" class="checkbox">
                        <div class="option_inner facebook">
                        <img src="image/museum.jpg"width="100%" height="400">
                            <div class="name"><h1>พิพิธภณฑ์</h1></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    ...
                    <input type="checkbox" class="checkbox">
                        <div class="option_inner facebook">
                        <img src="image/climbing.jpg"width="100%" height="400">
                            <div class="name"><h1>ปีนเขา</h1></div>
                        </div>
                    </div>
                </div>

                <div id="btn-next">
                    <a class="btn btn-primary" href="lifestyle3.php" role="button"><h1>ต่อไป</h1></a>
                </div>
